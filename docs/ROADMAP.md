...
| 7     | Recursion and formal verification of the lowering                                                                                                  | **in progress** (see `docs/README_phase7.md`; N.1, the executable IR spec and N.2 per-rule faithfulness landed) |
