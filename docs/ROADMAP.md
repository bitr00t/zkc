...
| 7     | Recursion and formal verification of the lowering                                                                                                  | **done** (see `docs/phase7.md`; N formal verification of the lowering: N.1 spec, N.2 per-rule faithfulness, N.3 mutation harness; O recursion: O.1 a FRI-fold verifier in the language, O.2 a real fold verified inside an outer proof) |
